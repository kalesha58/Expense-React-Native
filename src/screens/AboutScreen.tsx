      ...
      >
        <View style={[
          ...
          <Text style={[styles.aboutDescription, { color: colors.placeholder }]}>
            Oracle EBS iExpense simplifies expense reporting, allowing employees to submit, track, and manage business expenses while ensuring compliance with corporate policies through seamless integration with Oracle E-Business Suite.
          </Text>
        ...
        <View style={styles.footer}>
          <Text style={[styles.footerText, { color: colors.placeholder }]}>
            © 2025 Propel Apps . All rights reserved.
          </Text>
